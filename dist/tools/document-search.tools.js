import { categories } from "../document/types.js";
export function createSearchDocumentsTool(repository, projectId) {
    return {
        inputSchema: {
            type: "object",
            properties: {
        ...
        handler: async (args) => {
            try {
                ...
                const results = repository.searchDocuments(query, Math.min(limit, 10), category);
                if (results.length === 0) {
                    return {
                        content: [
                            {
...
export function createGetDocumentByIdTool(repository, projectId) {
    return {
        inputSchema: {
            type: "object",
            properties: {
...
export function createGetDocumentsByCategory(repository) {
    return {
        inputSchema: {
            type: "object",
            properties: {
        ...
        handler: async (args) => {
            try {
                ...
                const documents = repository.getDocumentsByCategory(category);
...
//# sourceMappingURL=document-search.tools.js.map